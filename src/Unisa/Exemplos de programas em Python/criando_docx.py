#This file makes a .docx (Word 2007) file from scratch, showing off most of the features of python-docx.
#If you need to make documents from scratch, you can use this file as a basis for your work.
