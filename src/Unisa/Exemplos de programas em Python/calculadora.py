...
#Importa todas funções do modulo Tkinter
from Tkinter import *
...
class Calculadora:
    ...
    #método construtor para iniciar a aplicação      
    def __init__(self,parent):
        ...
        #Cria os frames nescessários para a disposição
        #dos widgets
        ...
        #Este trecho de código é necessário para criar
        ...
        #Botões de rádio , para opcão do número de
        #casas decimais
        ...
        #Frame Criado para inserir os botões de radio
        #habilita/desabilita
        ...
        #Espaço para melhor posicionar os botões habilita/desabilita
        ...
        #Botão para limpar apenas o que está no visor 
        ...
        #Controle do número de vezes que o usuário clica
        #na vírgula
        self.ponto=1        
        
        #Variáveis usadas para guardar os valores do visor
        self.atual=0
        self.num=0
        self.mem=0
